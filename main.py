...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'warrior':
        return (f'{char_name} нанёс урон противнику равный {5 + rdt(3, 5)}')
    if char_class == 'mage':
        return (f'{char_name} нанёс урон противнику равный {5 + rdt(5, 10)}')
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный {5 + rdt(-3, -1)}')
...
def defence(char_name: str, char_class: str) -> str:
    """Defence function."""
    if char_class == 'warrior':
        return (f'{char_name} блокировал {10 + rdt(5, 10)} урона')
    if char_class == 'mage':
        return (f'{char_name} блокировал {10 + rdt(-2, 2)} урона')
    if char_class == 'healer':
        return (f'{char_name} блокировал {10 + rdt(2, 5)} урона')
    return (f'{char_name} блокировал {10} урона')


def special(char_name: str, char_class: str) -> str:
    """Calculates special move function."""
    if char_class == 'warrior':
        st = 80 + 25
        return (f'{char_name} применил специальное умение «Выносливость {st}»')
    if char_class == 'mage':
